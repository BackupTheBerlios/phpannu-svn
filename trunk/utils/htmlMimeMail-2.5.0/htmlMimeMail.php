...
* Last Modified..: $Date: 2005/08/08 22:12:19 $
* CVS Revision...: $Revision: 1.4.4.1 $
...
*/
	function &_addTextPart(&$obj, $text)
	{
		...
		if (is_object($obj)) {
			...
			return $return = & new Mail_mimePart($text, $params);
		}
	}
...
*/
	function &_addHtmlPart(&$obj)
	{
		...
		if (is_object($obj)) {
			...
			return $return = & new Mail_mimePart($this->html, $params);
		}
	}
...
*/
	function &_addMixedPart()
	{
		...
		return $return = & new Mail_mimePart('', $params);
	}
