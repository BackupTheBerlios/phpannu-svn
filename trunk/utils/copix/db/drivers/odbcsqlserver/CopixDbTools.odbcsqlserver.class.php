...
* @package   copix
* @subpackage copixdb
* @version   $Id: CopixDbTools.odbcsqlserver.class.php,v 1.4 2005/02/09 08:21:44 gcroes Exp $
 ...
 */
class CopixDBToolsODBCSQLServer extends CopixDBTools {
   function CopixDBToolsODBCSQLServer(&$connector){
