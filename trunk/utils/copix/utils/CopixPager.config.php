...
$options['PARAMS'] = Array(
    'nextPage'        => '&nbsp;<img src="./img/tools/next.gif" border="0" />&nbsp;',         // libellé lien vers la page suivante
    'previousPage'    => '&nbsp;<img src="./img/tools/back.gif" border="0" />&nbsp;',       // libellé lien vers la page précédente
    'lastPage'        => '&nbsp;<img src="./img/tools/last.png" border="0" />',              // libellé lien vers la dernière page
    'firstPage'       => '<img src="./img/tools/first.png" border="0" />&nbsp;',              // libellé lien vers la première page
