...
class CopixLDAPEntry {
   ...
   */
    function deleteAttributeValue ($attribute ,$index){
   ...
   */
    function _addSingleAttributeValue ($attribute, $value){
        if (isset ($this->$attribute)){
            if (!is_array($this->$attribute)) {
   ...
   */
    function CopixLDAPEntry ($_connectionID = null, $entryID = null) {
