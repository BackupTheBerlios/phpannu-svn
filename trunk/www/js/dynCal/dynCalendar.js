...
* Last Modified..: $Date: 2004/11/23 17:45:59 $
...
*/
	function dynCalendar_show()
	{
		...
		monthnames = new Array(dynCalendar.I18N.January, dynCalendar.I18N.February, dynCalendar.I18N.March, dynCalendar.I18N.April, dynCalendar.I18N.May, dynCalendar.I18N.June, dynCalendar.I18N.July, dynCalendar.I18N.August, dynCalendar.I18N.September, dynCalendar.I18N.October, dynCalendar.I18N.November, dynCalendar.I18N.December);
        ...
        */
		...
		html += '<tr>';
		/*
        html += '<td class="dynCalendar_dayname">'+dynCalendar.I18N.Sun+'</td>';
		html += '<td class="dynCalendar_dayname">'+dynCalendar.I18N.Mon+'</td>';
		html += '<td class="dynCalendar_dayname">'+dynCalendar.I18N.Tue+'</td>';
		html += '<td class="dynCalendar_dayname">'+dynCalendar.I18N.Wed+'</td>';
		html += '<td class="dynCalendar_dayname">'+dynCalendar.I18N.Thu+'</td>';
		html += '<td class="dynCalendar_dayname">'+dynCalendar.I18N.Fri+'</td>';
		html += '<td class="dynCalendar_dayname">'+dynCalendar.I18N.Sat+'</td></tr>';
        */
		html += '<td class="dynCalendar_dayname">'+dynCalendar.I18N.Sun+'</td>';
		html += '<td class="dynCalendar_dayname">'+dynCalendar.I18N.Mon+'</td>';
		html += '<td class="dynCalendar_dayname">'+dynCalendar.I18N.Tue+'</td>';
