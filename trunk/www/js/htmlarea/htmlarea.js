...
//
// $Id: htmlarea.js,v 1.2 2004/10/29 09:55:21 gcroes Exp $
...
HTMLArea.Config = function () {
	...
	this.pageStyle = '@import url("styles/styles_copix.css");';
		...
		if (HTMLArea.is_ie && root_tag == "head") {
			...
			for (i = 0; i < attrs.length; ++i) {
				...
				if (name != "style") {
					...
					if (typeof root[a.nodeName] != "undefined" && name != "href" && name != "src" && name != "onclick") {
